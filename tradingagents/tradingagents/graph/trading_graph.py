...
class TradingAgentsGraph:
    ...
    def propagate(self, company_name, trade_date, *, squeeze_decision: bool = True):
        ...
        Args:
            squeeze_decision: If True (default), second return value is a single rating
                token. If False, second value is the full portfolio-manager report and no
                extra LLM squeeze call is made (for Web UI).
        """
