...
| Problem | What to do |
|--------|------------|
| `TypeError: ... windows_utils.py ... Popen ...` when starting Web | Usually a broken env or patched `subprocess`. Use a clean venv; remove stray `~*` folders under `site-packages`. |
