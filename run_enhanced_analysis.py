...
def get_analyst_config(choice):
    ...
    configs = {
        "1": {
            ...
            "model": "deepseek-chat",
            "api_key": api_keys.get("deepseek", "") if api_keys else "sk-d28ae30a58cb496c9b40e0029d0ef2c1",
        ...
        "2": {
            ...
            "api_key": api_keys.get("kimi", "") if api_keys else "sk-PBksAJzkTW48yH12moqKci3hckekib80qJzMz63MG4XVfPyd",
        ...
        "3": {
            ...
            "api_key": api_keys.get("gemini", "") if api_keys else "AIzaSyAIOWEahqzuBZV5Ne7sm_IylWrzSld-Euk",
