...
# 强制设置DeepSeek API密钥（覆盖任何现有的环境变量）
...
# Load environment variables from .env file (but won't override our explicit set)
load_dotenv(override=False)

# 验证API密钥
api_key = os.environ.get("OPENAI_API_KEY", "")
expected_key = "sk-61d73d41bcb64482916d75f0709e121b"
